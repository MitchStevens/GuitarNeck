...
var DOM_HTML_HTMLMetaElement = require("../DOM.HTML.HTMLMetaElement");
...
var within = function (dictOrd) {
    return function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Interval line 80, column 1 - line 80, column 65: " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
};
var sup = function (v) {
    ...
    if (v instanceof Interval) {
        return new Data_Maybe.Just(v.value0.max);
    };
    throw new Error("Failed pattern match at Interval line 89, column 1 - line 89, column 25: " + [ v.constructor.name ]);
};
var show_interval = function (dictShow) {
    return new Data_Show.Show(function (v) {
        ...
        throw new Error("Failed pattern match at Interval line 39, column 1 - line 39, column 56: " + [ v.constructor.name ]);
    });
};
...
var is_degenerate = function (dictOrd) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Interval line 71, column 1 - line 71, column 58: " + [ v.constructor.name ]);
    };
};
var interval = function (dictOrd) {
    return function (min) {
        return function (max) {
            var $64 = Data_Ord.greaterThan(dictOrd)(min)(max);
            if ($64) {
                return EmptyInterval.value;
            };
            return new Interval({
...
var join_interval = function (dictOrd) {
    return new Data_Lattice.JoinSemilattice(function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Interval line 44, column 1 - line 44, column 66: " + [ v.constructor.name, v1.constructor.name ]);
        };
    });
};
var meet_interval = function (dictOrd) {
    return new Data_Lattice.MeetSemilattice(function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Interval line 49, column 1 - line 49, column 67: " + [ v.constructor.name, v1.constructor.name ]);
        };
    });
};
...
var inf = function (v) {
    ...
    if (v instanceof Interval) {
        return new Data_Maybe.Just(v.value0.min);
    };
    throw new Error("Failed pattern match at Interval line 85, column 1 - line 85, column 25: " + [ v.constructor.name ]);
};
var in_interval = function (dictOrd) {
    return function (x) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Interval line 75, column 1 - line 75, column 61: " + [ x.constructor.name, v.constructor.name ]);
        };
    };
};
