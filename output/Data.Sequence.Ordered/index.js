...
var split = function (dictPartial) {
    return function (f) {
        return function (x) {
            return Data_FingerTree.split(Data_Sequence_Internal.monoidKey)(Data_Sequence_Internal.measuredElemKey)(dictPartial)(function (y) {
...
var popLeast = function (dictOrd) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.Sequence.Ordered line 204, column 3 - line 206, column 66: " + [ v1.constructor.name ]);
    };
};
var popGreatest = function (dictOrd) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.Sequence.Ordered line 221, column 3 - line 223, column 66: " + [ v1.constructor.name ]);
    };
};
        ...
        return function (v1) {
            var go = function (as) {
                return function (bs) {
                    ...
                    throw new Error("Failed pattern match at Data.Sequence.Ordered line 169, column 5 - line 175, column 47: " + [ v2.constructor.name ]);
                };
            };
            return go(v)(v1);
        };
...
var least = function (dictOrd) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.Sequence.Ordered line 196, column 3 - line 198, column 37: " + [ v1.constructor.name ]);
    };
};
            ...
            var go = function (as) {
                return function (bs) {
                    ...
                    if (v2.value0 instanceof Data_FingerTree.ConsL && v2.value1 instanceof Data_FingerTree.ConsL) {
                        ...
                        throw new Error("Failed pattern match at Data.Sequence.Ordered line 187, column 9 - line 190, column 34: " + [ v3.constructor.name ]);
                    };
                    throw new Error("Failed pattern match at Data.Sequence.Ordered line 183, column 5 - line 190, column 34: " + [ v2.constructor.name ]);
                };
            };
            return go(v)(v1);
        };
...
var greatest = function (dictOrd) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.Sequence.Ordered line 212, column 3 - line 214, column 37: " + [ v1.constructor.name ]);
    };
};
...
var length = function ($111) {
    return Data_Newtype.unwrap(Data_Monoid_Additive.newtypeAdditive)(Data_Foldable.foldMap(foldableOrdSeq)(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(Data_Function["const"](1))($111));
};
...
var sort = function (dictFunctor) {
    return function (dictFoldable) {
        return function (dictUnfoldable) {
            return function (dictOrd) {
                return function ($112) {
                    return toUnfoldable(dictFunctor)(dictUnfoldable)(fromFoldable(dictFoldable)(dictOrd)($112));
                };
            };
        };
    };
