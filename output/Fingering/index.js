...
var shift_fingering = function (n) {
    return function (fingering) {
        ...
        var $14 = Data_Eq.eq(Interval.eq_interval(Fret.eq_fret))(Data_Lattice.meet(Interval.meet_interval(Fret.ord_fret))(range)(Interval.interval(Fret.ord_fret)(0)(11)))(Interval.EmptyInterval.value);
        if ($14) {
...
var centeroid_chord = function (neck_data) {
    return function (chord) {
        ...
        var $15 = Data_Foldable["null"](Data_Foldable.foldableArray)(points);
        if ($15) {
