...
var Data_FingerTree_Digit = require("../Data.FingerTree.Digit");
...
var showNode = function (dictShow) {
    return function (dictShow1) {
        return new Data_Show.Show(function (v) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 67, column 1 - line 67, column 57: " + [ v.constructor.name ]);
        });
    };
};
var showFingerTree = function (dictShow) {
    return function (dictShow1) {
        return new Data_Show.Show(function (v) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 134, column 1 - line 134, column 69: " + [ v.constructor.name ]);
        });
    };
};
...
var functorViewL = function (dictFunctor) {
    return new Data_Functor.Functor(function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 291, column 1 - line 291, column 56: " + [ f.constructor.name, v.constructor.name ]);
        };
    });
};
            ...
            return function ($copy_xs) {
                return function ($copy_ys) {
                    ...
                    function $tco_loop(dictMonoid, dictMeasured, dictEq, xs, ys) {
                        ...
                        throw new Error("Failed pattern match at Data.FingerTree line 154, column 3 - line 165, column 17: " + [ v.constructor.name ]);
                    };
                    while (!$tco_done) {
...
var head = function (dictMonoid) {
    return function (dictMeasured) {
        return function (x) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 332, column 10 - line 334, column 23: " + [ v.constructor.name ]);
        };
    };
};
var isEmpty = function (dictMonoid) {
    return function (dictMeasured) {
        return function (x) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 327, column 13 - line 329, column 21: " + [ v.constructor.name ]);
        };
    };
};
var tail = function (dictMonoid) {
    return function (dictMeasured) {
        return function (x) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 338, column 10 - line 340, column 24: " + [ v.constructor.name ]);
        };
    };
};
    ...
    return function (dictMonoid) {
        return function (dictMeasured) {
            var step = function (tree) {
                ...
                throw new Error("Failed pattern match at Data.FingerTree line 483, column 15 - line 485, column 38: " + [ v.constructor.name ]);
            };
...
var init = function (dictMonoid) {
    return function (dictMeasured) {
        return function (x) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 369, column 10 - line 371, column 24: " + [ v.constructor.name ]);
        };
    };
};
var last = function (dictMonoid) {
    return function (dictMeasured) {
        return function (x) {
            ...
            throw new Error("Failed pattern match at Data.FingerTree line 363, column 10 - line 365, column 23: " + [ v.constructor.name ]);
        };
    };
};
    ...
    return function (dictMonoid) {
        return function (dictMeasured) {
            var step = function (tree) {
                ...
                throw new Error("Failed pattern match at Data.FingerTree line 491, column 15 - line 493, column 38: " + [ v.constructor.name ]);
            };
            return Data_Unfoldable.unfoldr(dictUnfoldable)(step);
        };
    };
            ...
            return function ($copy_xs) {
                return function ($copy_ys) {
                    ...
                    function $tco_loop(dictMonoid, dictMeasured, dictOrd, xs, ys) {
                        ...
                        throw new Error("Failed pattern match at Data.FingerTree line 173, column 3 - line 182, column 23: " + [ v.constructor.name ]);
                    };
                    while (!$tco_done) {
