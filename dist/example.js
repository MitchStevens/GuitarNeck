...
(function(exports) {
  ...
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];        
  var str_y = function (neck_data) {
      return function (y) {
          return ((y * 2.0 + 1.0) * neck_data.height) / 12.0;
      };
  };
  var fret_x = function (neck_data) {
      return function (x) {
          var t = $$Math.pow(2.0)(-1.0 / 12.0);
          var n = Data_Int.toNumber(neck_data.num_frets);
          return (neck_data.width * (1.0 - $$Math.pow(t)(x))) / (1.0 - $$Math.pow(t)(n));
      };
  };
  var fret_marker = function (neck_data) {
      var f = fret_x(neck_data);
      return function (v) {
          if (v instanceof Fret.Open) {
              return 0.0;
          };
          if (v instanceof Fret.Fret) {
              return (f(Data_Int.toNumber(v.value0)) + f(Data_Int.toNumber(v.value0) - 1.0)) * 0.5;
          };
          throw new Error("Failed pattern match at NeckData line 27, column 25 - line 30, column 5: " + [ v.constructor.name ]);
      };
  };
  exports["fret_x"] = fret_x;
  exports["fret_marker"] = fret_marker;
  exports["str_y"] = str_y;
})(PS["NeckData"] = PS["NeckData"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  exports["cache_centeroid"] = cache_centeroid;
  exports["to_points"] = to_points;
  exports["centeroid_chord"] = centeroid_chord;
  exports["get_closest"] = get_closest;
  exports["semiring_point"] = semiring_point;
  exports["ring_point"] = ring_point;
})(PS["ChordFingering"] = PS["ChordFingering"] || {});
(function(exports) {
  /* global exports */
  "use strict";
...
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var ChordFingering = PS["ChordFingering"];
  var Control_Apply = PS["Control.Apply"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Array = PS["Data.Array"];
  ...
  var wipe_neck = Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
      ...
      return __unused()((function () {
          ...
          throw new Error("Failed pattern match at CanvasOperations line 99, column 3 - line 100, column 3: " + [ v.constructor.name ]);
      })())();
  });
  ...
  var paint_strings = function (v) {
      ...
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle(string_color)(v.value0))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(single_string)(Data_Array.range(0)(5))));
  };
  ...
  var paint_inlays = function (v) {
      var y = v.value1.height / 6.0;
      var x = NeckData.fret_marker(v.value1)(new Fret.Fret(12));
      ...
      var inlay_points = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ ChordFingering.point(x)(y), ChordFingering.point(x)(y * 5.0) ])(Data_Functor.map(Data_Functor.functorArray)(function (x1) {
          return ChordFingering.point(NeckData.fret_marker(v.value1)(new Fret.Fret(x1)))(y * 3.0);
      })([ 3, 5, 7, 9, 15, 17, 19, 21 ]));
          ...
          return __unused()((function () {
              if (v instanceof Data_Maybe.Just) {
                  return function __do() {
                      ...
                      return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle(neck_color)(v1))(Graphics_Canvas.fillRect(v1)({
                          x: 0.0,
                          y: 0.0,
                          w: neck.width,
                          h: neck.height
                      })))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fret(tuple))(Data_Array.range(0)(neck.num_frets))))(paint_inlays(tuple)))(paint_strings(tuple))();
                  };
              };
              throw new Error("Failed pattern match at CanvasOperations line 35, column 3 - line 36, column 3: " + [ v.constructor.name ]);
          })())();
      });
  };
          ...
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
              ...
              return __unused()((function () {
                  if (v instanceof Data_Maybe.Just) {
                      return function __do() {
                          var v1 = Graphics_Canvas.getContext2D(v.value0)();
                          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setGlobalAlpha(v1)(0.35))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fingering(v1))(ChordFingering.to_points(neck)(fingering))))(Graphics_Canvas.setGlobalAlpha(v1)(1.0))();
                      };
                  };
                  throw new Error("Failed pattern match at CanvasOperations line 82, column 3 - line 83, column 3: " + [ v.constructor.name ]);
              })())();
          });
      };
  };
  exports["paint_neck"] = paint_neck;
  exports["paint_chord"] = paint_chord;
  exports["wipe_neck"] = wipe_neck;
})(PS["CanvasOperations"] = PS["CanvasOperations"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var show_extension = new Data_Show.Show(function (v) {
      ...
      if (v instanceof Add) {
          ...
          return "(add" + (Data_Show.show(Data_Show.showInt)(v.value0) + ")");
      };
  ...
  exports["show_extension"] = show_extension;
})(PS["Music.Extension"] = PS["Music.Extension"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Data_Array = PS["Data.Array"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_Symbol = PS["Data.Symbol"];
  var Music_Degree = PS["Music.Degree"];
  var Prelude = PS["Prelude"];        
  var Major = (function () {
      function Major() {
  ...
  var show_mode = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(generic_mode)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Major";
  ...
  exports["generic_mode"] = generic_mode;
  exports["show_mode"] = show_mode;
})(PS["Music.Mode"] = PS["Music.Mode"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Data_Array = PS["Data.Array"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_String = PS["Data.String"];
  var Music_Transpose = PS["Music.Transpose"];
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];        
  var C = (function () {
      function C() {
  ...
  exports["Bb"] = Bb;
  exports["B"] = B;
  exports["pcToInt"] = pcToInt;
  exports["pitch"] = pitch;
  exports["show_pitchclass"] = show_pitchclass;
})(PS["Music.Note"] = PS["Music.Note"] || {});
(function(exports) {
    "use strict";
  var Control_Apply = PS["Control.Apply"];
  var Data_Array = PS["Data.Array"];
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Data_Show = PS["Data.Show"];
  var Music_Extension = PS["Music.Extension"];
  var Music_Key = PS["Music.Key"];
  var Music_Mode = PS["Music.Mode"];
  var Music_Note = PS["Music.Note"];
  var Music_Scale = PS["Music.Scale"];
  var Music_Transpose = PS["Music.Transpose"];
  var Prelude = PS["Prelude"];        
  var Chord = (function () {
  ...
  var show_chord = new Data_Show.Show(function (v) {
      var mode_str = (function () {
          ...
          if (v.value1 instanceof Music_Mode.Ionian) {
              return "maj";
          };
          if (v.value1 instanceof Music_Mode.Dorian) {
              return "min";
          };
          if (v.value1 instanceof Music_Mode.Phrygian) {
              return "min";
          };
          if (v.value1 instanceof Music_Mode.Lydian) {
              return "maj";
          };
          if (v.value1 instanceof Music_Mode.Mixolydian) {
              var $19 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (ex) {
                  return Music_Extension.degree(ex) === 7;
              })(v.value2);
              if ($19) {
                  return "dom";
              };
          ...
          if (v.value1 instanceof Music_Mode.Aeolian) {
              return "min";
          };
          if (v.value1 instanceof Music_Mode.Locrian) {
              return "min";
          };
          ...
          throw new Error("Failed pattern match at Music.Chord line 22, column 18 - line 34, column 1: " + [ v.value1.constructor.name ]);
      })();
      return Data_Show.show(Music_Note.show_pitchclass)(v.value0) + (mode_str + Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(Data_Show.show(Music_Extension.show_extension))(v.value2));
  });
 ...
 */  
  ...
  exports["Chord"] = Chord;
  exports["mk_chord"] = mk_chord;
  exports["show_chord"] = show_chord;
})(PS["Music.Chord"] = PS["Music.Chord"] || {});
(function(exports) {
    "use strict";
  var ChordFingering = PS["ChordFingering"];
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Fret = PS["Fret"];
  var Music_Chord = PS["Music.Chord"];
  var NeckData = PS["NeckData"];
  ...
  var Prelude = PS["Prelude"];
  var moveable_fingerings = (function () {
      var init = Control_Monad_Aff.launchAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("http://www.mitchstevens.com/guitar/barre_chords"))(function (v) {
          var v1 = Debug_Trace.trace(Debug_Trace.warn())(Data_Show.show(Data_Show.showString)(v.response))(Control_Category.id(Control_Category.categoryFn));
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
      }));
      return Control_Apply.applyFirst(Control_Monad_Eff.applyEff)(Control_Monad_Eff_Ref.newRef(Data_StrMap.empty))(init);
  })();
  var all_fingerings = function (chords) {
      return function __do() {
          var v = Control_Bind.bind(Control_Monad_Eff.bindEff)(moveable_fingerings)(Control_Monad_Eff_Ref.readRef)();
          return Data_Maybe.fromMaybe([  ])(Data_StrMap.lookup("min7")(v));
      };
  };
 ...
 *       pure unit
 */  
  var get_fingerings = function (neck) {
      return function (chord) {
          return function __do() {
              var v = all_fingerings(chord)();
              var $14 = Data_Array["null"](v);
              if ($14) {
                  return Control_Monad_Eff_Exception.throwException(Control_Monad_Eff_Exception.error("Couldn't find any chord fingerings for chord " + Data_Show.show(Music_Chord.show_chord)(chord)))();
              };
              return Data_Array.mapMaybe(ChordFingering.cache_centeroid(neck))(v);
          };
      };
  };
  exports["moveable_fingerings"] = moveable_fingerings;
  exports["get_fingerings"] = get_fingerings;
  exports["all_fingerings"] = all_fingerings;
})(PS["Reader"] = PS["Reader"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
...
(function(exports) {
          ...
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)([  ])(parse_head_ext))(function (v2) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(parse_tail_ext))(function (v3) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity))(function () {
                      ...
                      throw new Error("Failed pattern match at Parser line 91, column 3 - line 93, column 25: " + [ v4.constructor.name ]);
                  });
              });
          });
      });
  ...
  exports["parse_accidental"] = parse_accidental;
  exports["parse_mode"] = parse_mode;
  exports["parse_head_ext"] = parse_head_ext;
  exports["parse_tail_ext"] = parse_tail_ext;
  exports["parse_extension"] = parse_extension;
  exports["parse_chord"] = parse_chord;
})(PS["Parser"] = PS["Parser"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  ...
  var display_chord = function (v) {
      var ext_html = function (ext) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("extension") ])([ Halogen_HTML_Core.text(Data_Show.show(Music_Extension.show_extension)(ext)) ]);
      };
      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.id_("chord-display") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("root") ])([ Halogen_HTML_Core.text(Data_Show.show(Music_Note.show_pitchclass)(v.value0)) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("mode") ])([ Halogen_HTML_Core.text(Data_Show.show(Music_Mode.show_mode)(v.value1)) ]), Halogen_HTML_Elements.span_(Data_Functor.map(Data_Functor.functorArray)(ext_html)(v.value2)) ]);
  };
  var chord_input = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(StringInput.create)) ]), Data_Either.either(display_error)(display_chord)(state) ]);
      };
      ...
      var $$eval = function (v) {
          if (v instanceof StringInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var v1 = Text_Parsing_Parser.runParser(v.value0)(Parser.parse_chord);
                  if (v1 instanceof Data_Either.Left) {
                      return Data_Either.Left.create(Data_Show.show(Text_Parsing_Parser.showParseError)(v1.value0));
                  };
                  if (v1 instanceof Data_Either.Right) {
                      return new Data_Either.Right(v1.value0);
                  };
                  throw new Error("Failed pattern match at UI.ChordInput line 52, column 15 - line 54, column 35: " + [ v1.constructor.name ]);
              })()))(function () {
          ...
          throw new Error("Failed pattern match at UI.ChordInput line 50, column 10 - line 58, column 21: " + [ v.constructor.name ]);
      };
  ...
  exports["CurrentChord"] = CurrentChord;
  exports["chord_input"] = chord_input;
  exports["display_error"] = display_error;
  exports["display_chord"] = display_chord;
})(PS["UI.ChordInput"] = PS["UI.ChordInput"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CanvasOperations = PS["CanvasOperations"];
  var ChordFingering = PS["ChordFingering"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Apply = PS["Control.Apply"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var UI_ChordInput = PS["UI.ChordInput"];        
  ...
  var calc_offset = function (element) {
      return Control_Apply.lift2(Control_Monad_Eff.applyEff)(ChordFingering.point)(DOM_HTML_HTMLElement.offsetLeft(element))(DOM_HTML_HTMLElement.offsetTop(element));
  };
  var guitar_neck = function (neck) {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("both-canvases") ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_neck"), Halogen_HTML_Properties.width(Data_Int.ceil(state.neck_data.width)), Halogen_HTML_Properties.height(Data_Int.ceil(state.neck_data.height)) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_notes"), Halogen_HTML_Properties.width(Data_Int.ceil(state.neck_data.width)), Halogen_HTML_Properties.height(Data_Int.ceil(state.neck_data.height)), Halogen_HTML_Events.onMouseMove(Halogen_HTML_Events.input(MouseMove.create)) ]) ]), Halogen_HTML.slot(ChordInputSlot.value)(UI_ChordInput.chord_input)(Data_Unit.unit)(Halogen_HTML_Events.input(ChordInputMessage.create)) ]);
      };
      var initialState = {
          neck_data: neck,
          chords: [  ],
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof MouseMove) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Halogen_Aff_Util.selectElement("#content #guitar")))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Semiring.zero(ChordFingering.semiring_point)))(calc_offset)(v2)))(function (v3) {
                          var p = Data_Ring.sub(ChordFingering.ring_point)(ChordFingering.point(Data_Int.toNumber(DOM_Event_MouseEvent.pageX(v.value0)))(Data_Int.toNumber(DOM_Event_MouseEvent.pageY(v.value0))))(v3);
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Reader.get_fingerings(v1.neck_data)(chord)))(function (v4) {
                              var closest = ChordFingering.get_closest(Data_Foldable.foldableArray)(v1.neck_data)(p)(v4);
                              ...
                              throw new Error("Failed pattern match at UI.GuitarNeck line 135, column 7 - line 137, column 29: " + [ closest.constructor.name ]);
                          });
                      });
                  });
              });
          ...
          throw new Error("Failed pattern match at UI.GuitarNeck line 113, column 10 - line 151, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["ChordInputSlot"] = ChordInputSlot;
  exports["PaintNeck"] = PaintNeck;
  exports["SetNeck"] = SetNeck;
  exports["WipeNeck"] = WipeNeck;
  exports["ClearAll"] = ClearAll;
  exports["MouseMove"] = MouseMove;
  exports["SetChord"] = SetChord;
  exports["ChordInputMessage"] = ChordInputMessage;
  exports["guitar_neck"] = guitar_neck;
  exports["calc_offset"] = calc_offset;
  exports["chord"] = chord;
  exports["eq_slot"] = eq_slot;
  exports["ord_slot"] = ord_slot;
})(PS["UI.GuitarNeck"] = PS["UI.GuitarNeck"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Node_FS = PS["Node.FS"];
  var Prelude = PS["Prelude"];
  var UI_GuitarNeck = PS["UI.GuitarNeck"];        
  ...
  exports["default_neck_data"] = default_neck_data;
  exports["main"] = main;
  exports["await_guitar"] = await_guitar;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
