...
(function(exports) {
  ...
  var GetChord = (function () {
      function GetChord(value0) {
          this.value0 = value0;
      };
      GetChord.create = function (value0) {
          return new GetChord(value0);
      };
      return GetChord;
  })();
  var width = 500;
  ...
  var paint_fret = function (ctx) {
      return function (fret_num) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
              var v = Graphics_Canvas.setFillStyle("#000000")(ctx)();
  ...
  var init_neck = Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
      ...
      return __unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  var v2 = Graphics_Canvas.setFillStyle("#edc889")(v1)();
                  ...
                  return paint_fret(v1)(5)();
              };
          };
          throw new Error("Failed pattern match at GuitarNeck line 82, column 3 - line 83, column 3: " + [ v.constructor.name ]);
      })())();
  });
  var guitar_neck = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_neck"), Halogen_HTML_Properties.width(width), Halogen_HTML_Properties.height(height) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_notes"), Halogen_HTML_Properties.width(width), Halogen_HTML_Properties.height(height) ]) ]);
      };
      var initialState = [ new Data_Tuple.Tuple(Data_Unit.unit, Data_Unit.unit) ];
      var $$eval = function (v) {
          if (v instanceof PaintNeck) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(init_neck))(function (v1) {
          ...
          if (v instanceof GetChord) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
          };
          throw new Error("Failed pattern match at GuitarNeck line 70, column 10 - line 78, column 40: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(GuitarNeck.guitar_neck)(Data_Unit.unit)(v))(function (v1) {
          return v1.query(new GuitarNeck.PaintNeck(Data_Unit.unit));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
