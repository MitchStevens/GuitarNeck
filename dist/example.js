...
(function(exports) {
  ...
  var height = 120;
  var str_y = function (y) {
      return ((y * 2.0 + 1.0) * Data_Int.toNumber(height)) / 12.0;
  };
  var paint_strings = function (ctx) {
      var single_string = function (n) {
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.beginPath(ctx))(Graphics_Canvas.fillRect(ctx)({
              x: 0.0,
              y: str_y(Data_Int.toNumber(n)),
              w: Data_Int.toNumber(width),
              h: 1.0
          }));
      };
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dddddd")(ctx))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(single_string)(Data_Array.range(0)(5))));
  };
  var fret_x = function (x) {
      var t = $$Math.pow(2.0)(-1.0 / 12.0);
      return (Data_Int.toNumber(width) * (1.0 - $$Math.pow(t)(x))) / (1.0 - $$Math.pow(t)(Data_Int.toNumber(num_frets)));
  };
  var paint_fret = function (ctx) {
      return function (fret_num) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#000000")(ctx))(Graphics_Canvas.fillRect(ctx)({
              x: fret_x(Data_Int.toNumber(fret_num)),
              y: 0.0,
              w: 2.0,
  ...
  var between_fret = function (fret) {
      var n = Data_Int.toNumber(fret);
      return (fret_x(n) + fret_x(n - 1.0)) * 0.5;
  };
  var paint_chord = function (chord) {
      var paint_fingering = function (ctx) {
          return function (v) {
              return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.beginPath(ctx))(Graphics_Canvas.arc(ctx)(circle({
                  x: between_fret(v.value1),
                  y: str_y(Chord.str_to_num(v.value0)),
                  r: 10.0
          ...
          return __unused()((function () {
              if (v instanceof Data_Maybe.Just) {
                  return function __do() {
                      ...
                      return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dd2211")(v1))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fingering(v1))(chord))();
                  };
              };
              throw new Error("Failed pattern match at GuitarNeck line 149, column 3 - line 150, column 3: " + [ v.constructor.name ]);
          })())();
      });
  };
  var paint_inlays = function (ctx) {
      var single_inlay = function (fret) {
          var circ = circle({
              x: between_fret(fret),
              y: Data_Int.toNumber(height) * 0.5,
              r: 5.0
          });
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.beginPath(ctx))(Graphics_Canvas.arc(ctx)(circ)))(Graphics_Canvas.fill(ctx));
      };
      var _y = Data_Int.toNumber(height) / 6.0;
      var _x = between_fret(12);
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dddddd")(ctx))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(single_inlay)([ 3, 5, 7, 9, 15, 17, 19, 21 ])))(Graphics_Canvas.beginPath(ctx)))(Graphics_Canvas.arc(ctx)(circle({
          x: _x,
          y: _y * 1.0,
          r: 5.0
      }))))(Graphics_Canvas.fill(ctx)))(Graphics_Canvas.beginPath(ctx)))(Graphics_Canvas.arc(ctx)(circle({
          x: _x,
          y: _y * 5.0,
          r: 5.0
      }))))(Graphics_Canvas.fill(ctx)));
  ...
  var init_neck = function (neck_data) {
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return function __do() {
                      ...
                      return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#edc889")(v1))(Graphics_Canvas.fillRect(v1)({
                          ...
                          w: neck_data.width,
                          h: neck_data.height
                      })))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fret(v1))(Data_Array.range(0)(num_frets))))(paint_inlays(v1)))(paint_strings(v1))();
                  };
              };
              throw new Error("Failed pattern match at GuitarNeck line 94, column 3 - line 95, column 3: " + [ v.constructor.name ]);
          })())();
      });
  };
  var guitar_neck = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("both_canvases") ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_neck"), Halogen_HTML_Properties.width(width), Halogen_HTML_Properties.height(height) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_notes"), Halogen_HTML_Properties.width(width), Halogen_HTML_Properties.height(height) ]) ]), Halogen_HTML_Elements.select_([ Halogen_HTML_Elements.option_([ Halogen_HTML_Core.text("example1") ]) ]) ]);
      };
      var initialState = [  ];
      var $$eval = function (v) {
          if (v instanceof PaintNeck) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(init_neck(initial_neck_data)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0));
          };
          ...
          if (v instanceof SetChord) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(paint_chord(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          throw new Error("Failed pattern match at GuitarNeck line 82, column 10 - line 89, column 49: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(GuitarNeck.guitar_neck)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(new GuitarNeck.PaintNeck(Data_Unit.unit)))(function () {
