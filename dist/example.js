...
(function(exports) {
  ...
  var str_to_num = function (v) {
      ...
      throw new Error("Failed pattern match at Chord line 21, column 14 - line 27, column 9: " + [ v.constructor.name ]);
  };
  exports["E4"] = E4;
  exports["B3"] = B3;
  exports["G3"] = G3;
...
(function(exports) {
  ...
  var PaintNeck = (function () {
      function PaintNeck(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PaintNeck.create = function (value0) {
          return function (value1) {
              return new PaintNeck(value0, value1);
          };
      };
      return PaintNeck;
  })();
  ...
  var str_y = function (state) {
      return function (y) {
          return ((y * 2.0 + 1.0) * state.neck_data.height) / 12.0;
      };
  };
  var paint_strings = function (v) {
      var single_string = function (n) {
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.beginPath(v.value0))(Graphics_Canvas.fillRect(v.value0)({
              x: 0.0,
              y: str_y(v.value1)(Data_Int.toNumber(n)),
              w: v.value1.neck_data.width,
              h: 1.0
          }));
      };
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dddddd")(v.value0))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(single_string)(Data_Array.range(0)(5))));
  };
  var initial_neck_data = {
      width: 600.0,
      height: 120.0,
      num_frets: 15
  };
  var fret_x = function (state) {
      return function (x) {
          var t = $$Math.pow(2.0)(-1.0 / 12.0);
          var n = Data_Int.toNumber(state.neck_data.num_frets);
          return (state.neck_data.width * (1.0 - $$Math.pow(t)(x))) / (1.0 - $$Math.pow(t)(n));
      };
  };
  var paint_fret = function (v) {
      return function (fret_num) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#000000")(v.value0))(Graphics_Canvas.fillRect(v.value0)({
              x: fret_x(v.value1)(Data_Int.toNumber(fret_num)),
              y: 0.0,
              w: 2.0,
              h: v.value1.neck_data.height
          })));
      };
  };
  ...
  var between_fret = function (state) {
      return function (fret) {
          var n = Data_Int.toNumber(fret);
          var f = fret_x(state);
          return (f(n) + f(n - 1.0)) * 0.5;
      };
  };
  var paint_fingering = function (v) {
      return function (v1) {
          var _y = str_y(v.value1)(Chord.str_to_num(v1.value0));
          var _x = between_fret(v.value1)(v1.value1);
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dd2211")(v.value0))(Graphics_Canvas.setGlobalAlpha(v.value0)(0.35)))(Graphics_Canvas.beginPath(v.value0)))(Graphics_Canvas.arc(v.value0)(circle({
              x: _x,
              y: _y,
              r: 8.5
          }))))(Graphics_Canvas.fill(v.value0)))(Graphics_Canvas.setGlobalAlpha(v.value0)(1.0)));
      };
  };
  var paint_chord = function (state) {
              ...
              return __unused()((function () {
                  if (v instanceof Data_Maybe.Just) {
                      return function __do() {
                          ...
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fingering(new Data_Tuple.Tuple(v1, state)))(chord)();
                      };
                  };
                  throw new Error("Failed pattern match at GuitarNeck line 184, column 3 - line 185, column 3: " + [ v.constructor.name ]);
              })())();
          });
      };
  };
  var paint_inlays = function (v) {
      var single_inlay = function (fret) {
          var circ = circle({
              x: between_fret(v.value1)(fret),
              y: v.value1.neck_data.height * 0.5,
              r: 5.0
          });
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.beginPath(v.value0))(Graphics_Canvas.arc(v.value0)(circ)))(Graphics_Canvas.fill(v.value0));
      };
      var _y = v.value1.neck_data.height / 6.0;
      var _x = between_fret(v.value1)(12);
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#dddddd")(v.value0))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(single_inlay)([ 3, 5, 7, 9, 15, 17, 19, 21 ])))(Graphics_Canvas.beginPath(v.value0)))(Graphics_Canvas.arc(v.value0)(circle({
          x: _x,
          y: _y * 1.0,
          r: 5.0
      }))))(Graphics_Canvas.fill(v.value0)))(Graphics_Canvas.beginPath(v.value0)))(Graphics_Canvas.arc(v.value0)(circle({
          x: _x,
          y: _y * 5.0,
          r: 5.0
      }))))(Graphics_Canvas.fill(v.value0)));
  };
  var init_neck = function (state) {
      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
          ...
          return __unused()((function () {
              if (v instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v1 = Graphics_Canvas.getContext2D(v.value0)();
                      var tuple = new Data_Tuple.Tuple(v1, state);
                      return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Control_Apply.applySecond(Control_Monad_Eff.applyEff)(Graphics_Canvas.setFillStyle("#edc889")(v1))(Graphics_Canvas.fillRect(v1)({
                          x: 0.0,
                          y: 0.0,
                          w: state.neck_data.width,
                          h: state.neck_data.height
                      })))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(paint_fret(tuple))(Data_Array.range(0)(state.neck_data.num_frets))))(paint_inlays(tuple)))(paint_strings(tuple))();
                  };
              };
              throw new Error("Failed pattern match at GuitarNeck line 120, column 3 - line 121, column 3: " + [ v.constructor.name ]);
          })())();
      });
  };
  var guitar_neck = (function () {
      var render = function (state) {
          var show_mouseevent = function (me) {
              return "client: (" + (Data_Show.show(Data_Show.showInt)(DOM_Event_MouseEvent.clientX(me)) + (", " + (Data_Show.show(Data_Show.showInt)(DOM_Event_MouseEvent.clientY(me)) + ")")));
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("both_canvases") ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_neck"), Halogen_HTML_Properties.width(Data_Int.ceil(state.neck_data.width)), Halogen_HTML_Properties.height(Data_Int.ceil(state.neck_data.height)) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_("guitar_notes"), Halogen_HTML_Properties.width(Data_Int.ceil(state.neck_data.width)), Halogen_HTML_Properties.height(Data_Int.ceil(state.neck_data.height)), Halogen_HTML_Events.onMouseMove(Halogen_HTML_Events.input(MouseMove.create)) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.textarea([  ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(Data_Maybe.fromMaybe("Nothing")(Data_Functor.map(Data_Maybe.functorMaybe)(show_mouseevent)(state.zzz)))) ]) ]);
      };
      var initialState = {
          neck_data: initial_neck_data,
          chords: [  ],
          focused: Data_Maybe.Nothing.value,
          zzz: Data_Maybe.Nothing.value
      };
      var $$eval = function (v) {
          if (v instanceof PaintNeck) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var new_state = (function () {
                      ...
                      $60.neck_data = v.value0;
                      return $60;
                  })();
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(init_neck(new_state)))(function () {
          ...
          if (v instanceof MouseMove) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $68.zzz = new Data_Maybe.Just(v.value0);
                      return $68;
                  })()))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
          ...
          if (v instanceof SetChord) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(paint_chord(v1)(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          throw new Error("Failed pattern match at GuitarNeck line 99, column 10 - line 115, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["initial_neck_data"] = initial_neck_data;
  ...
  exports["init_neck"] = init_neck;
  exports["fret_x"] = fret_x;
  exports["str_y"] = str_y;
  exports["between_fret"] = between_fret;
  exports["paint_fret"] = paint_fret;
  exports["paint_inlays"] = paint_inlays;
  exports["paint_strings"] = paint_strings;
  exports["paint_chord"] = paint_chord;
  exports["paint_fingering"] = paint_fingering;
  exports["circle"] = circle;
})(PS["GuitarNeck"] = PS["GuitarNeck"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Graphics_Canvas = PS["Graphics.Canvas"];
  var GuitarNeck = PS["GuitarNeck"];
  var Halogen_Aff = PS["Halogen.Aff"];
  var Halogen_Aff_Util = PS["Halogen.Aff.Util"];
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_VDom_Driver = PS["Halogen.VDom.Driver"];
  var Prelude = PS["Prelude"];        
  var test_chord = [ new Data_Tuple.Tuple(Chord.B3.value, 5), new Data_Tuple.Tuple(Chord.G3.value, 5), new Data_Tuple.Tuple(Chord.D3.value, 5), new Data_Tuple.Tuple(Chord.A2.value, 3) ];
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(GuitarNeck.guitar_neck)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(new GuitarNeck.PaintNeck(GuitarNeck.initial_neck_data, Data_Unit.unit)))(function () {
              return v1.query(new GuitarNeck.SetChord(test_chord, Data_Unit.unit));
          });
      });
  }));
  exports["test_chord"] = test_chord;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
